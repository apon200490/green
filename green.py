...
def banner():
	...
	print (f"""
               ...
               AAA               PPPPPPPPPPPPPPPPP   IIIIIIIIIINNNNNNNN        NNNNNNNN
              A:::A              P::::::::::::::::P  I::::::::IN:::::::N       N::::::N
             A:::::A             P::::::PPPPPP:::::P I::::::::IN::::::::N      N::::::N
            A:::::::A            PP:::::P     P:::::PII::::::IIN:::::::::N     N::::::N
           A:::::::::A             P::::P     P:::::P  I::::I  N::::::::::N    N::::::N
          A:::::A:::::A            P::::P     P:::::P  I::::I  N:::::::::::N   N::::::N
         A:::::A A:::::A           P::::PPPPPP:::::P   I::::I  N:::::::N::::N  N::::::N
        A:::::A   A:::::A          P:::::::::::::PP    I::::I  N::::::N N::::N N::::::N
       A:::::A     A:::::A         P::::PPPPPPPPP      I::::I  N::::::N  N::::N:::::::N
      A:::::AAAAAAAAA:::::A        P::::P              I::::I  N::::::N   N:::::::::::N
     A:::::::::::::::::::::A       P::::P              I::::I  N::::::N    N::::::::::N
    A:::::AAAAAAAAAAAAA:::::A      P::::P              I::::I  N::::::N     N:::::::::N
   A:::::A             A:::::A   PP::::::PP          II::::::IIN::::::N      N::::::::N
  A:::::A               A:::::A  P::::::::P          I::::::::IN::::::N       N:::::::N
 A:::::A                 A:::::A P::::::::P          I::::::::IN::::::N        N::::::N
AAAAAAA                   AAAAAAAPPPPPPPPPP          IIIIIIIIIINNNNNNNN         NNNNNNN
                                                                                       


\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91m APON
\033[32m ║ FB > \x1b[1;97m TUMER JANA LAGBO NA
\033[95m ║ GITHUB > \x1b[0;34mapon200490
\33[1;96m║ CONTACT > \033[93m+8801643537105 
\033[93m ║ TOOL  STATUS > \33[1;96mPERSONAL
\33[1;96m╚═════════════════════════════════════════╝""")
def login():
	#print(logo)
	banner()
	...
	if Akash in ['m']:
		...
		os.system('xdg-open https://wa.me/+88011643537105')
	elif Akash in ['0']:
